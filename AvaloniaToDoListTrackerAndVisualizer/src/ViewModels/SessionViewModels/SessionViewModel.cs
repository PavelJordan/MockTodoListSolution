...
public partial class SessionViewModel: ViewModelBase
{
    ...
    public SessionViewModel(TaskListViewModel tasks, GroupListViewModel groups, Session session)
    {
        Tasks = tasks;
        Groups = groups;
        Timer = new TimerViewModel(session);
