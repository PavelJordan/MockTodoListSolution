...
public class MockMainWindowViewModel: MainWindowViewModel
{
    public MockMainWindowViewModel(): base(new TaskApplicationFileService())
    {
        ...
        Tasks.AllTasks.Collection.Add(new TaskViewModel(new TaskModel("Hello, World 3!"), groups, Localization));
        ...
        Tasks.AllTasks.Collection.Add(new TaskViewModel(new TaskModel("Hello, World 4!"), groups, Localization));
